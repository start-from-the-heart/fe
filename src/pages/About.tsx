      ...
      <div className="flex flex-col md:flex-row items-start md:items-center md:justify-between gap-6 mb-8">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <button
            ...
            className="mt-4 text-white bg-yellow-500 font-medium rounded-full text-sm px-5 py-2"
          >
            Pokemon
          </button>
          <button
            onClick={() => navigate("/weather")}
            className="mt-4 text-white bg-red-500 font-medium rounded-full text-sm px-5 py-2"
          >
            Weather App
          </button>
        </div>
